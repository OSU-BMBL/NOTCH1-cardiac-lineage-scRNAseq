...
table(this_combined$cell_type) / sum(as.numeric(table(this_combined$cell_type)))
print_sample(this_sample_name)
print_genes(this_sample_name, genes = c("MIXL1"))
print_violin(this_sample_name, genes = c("MIXL1"))
```
...
table(this_combined$cell_type) / sum(as.numeric(table(this_combined$cell_type)))
print_sample(this_sample_name)
print_genes(this_sample_name, genes = c("ISL1"))
print_violin(this_sample_name, genes = c("ISL1"))
```
...
table(this_combined$cell_type) / sum(as.numeric(table(this_combined$cell_type)))
print_sample(this_sample_name)
print_genes(this_sample_name, genes = c("TNNT2", "DDR2"))
```
...
table(this_combined$cell_type) / sum(as.numeric(table(this_combined$cell_type)))
print_sample(this_sample_name)
print_genes(this_sample_name, genes = c("TNNT2", "MYL2"))
```
