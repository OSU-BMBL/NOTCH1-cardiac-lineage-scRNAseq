...
tmp_levels[c(8, 11, 14, 16, 19)] <- "iPSCs"
...
tmp_levels[c(1, 3)] <- "Cardiac mesoderm"
...
FeaturePlot(
  this_combined,
  features = c("CALD1","MEF2C","SOX10","MIXL1","EOMES","MESP1"),
  ncol = 3,
  keep.scale = NULL,
  pt.size = 0.6,
  cols = two_color
...
tmp_ident <- as.factor(this_combined$seurat_clusters)
#length(levels(tmp_ident))
tmp_ident <- as.factor(this_combined$seurat_clusters)
tmp_levels <- rep("Undecided", length(levels(tmp_ident)))
levels(tmp_ident) <- tmp_levels
...
N1KO5: iPSCs, Mesoderm, Cardiac mesoderm, SHF progenitor, FHF progenitor, Epicardial progenitor
...
tmp_levels[c(14)] <- "iPSCs"
tmp_levels[c(13)] <- "SHF progenitor"
...
N1KO10: Cardiac mesoderm, SHF progenitor, FHF progenitor, Epicardial progenitor, Atrial cardiomyocytes, Ventricular cardiomyocytes, Pacemaker cells, Vascular smooth muscle cells, Cardiac fibroblast
...
tmp_levels[c(2, 7, 8, 9)] <- "SHF progenitor"
tmp_levels[c(3, 5, 14)] <- "Early cardiomyocytes"
...
tmp_levels[c(1, 7, 9, 12, 13)] <- "Cardiac fibroblast"
tmp_levels[c(1, 7, 9, 12, 13)] <- "SHF progenitor"
tmp_levels[c(1, 7, 9, 12, 13)] <- "FHF progenitor"
levels(tmp_ident) <- tmp_levels
...
tmp_ident <- as.factor(this_combined$seurat_clusters)
tmp_levels <- rep("Early cardiomyocytes", length(levels(tmp_ident)))
tmp_levels[c(10)] <- "Epicardial progenitors"
...
tmp_levels[c(11)] <- "Pacemaker cell"
tmp_levels[c(2, 6)] <- "Cardiac fibroblast"
