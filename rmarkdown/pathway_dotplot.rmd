...
enriched_combined <- enrichr(this_up, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(2, 4, 5, 24, 11), ]
...
enriched_combined <- enrichr(this_down, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(1, 19, 21, 23, 34), ]
...
enriched_combined <- enrichr(this_up, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(1, 3, 7, 25, 26), ]
...
enriched_combined <- enrichr(this_down, dbs)
this_terms <- rbind(enriched_combined$GO_Biological_Process_2018, enriched_combined$KEGG_2019_Human)
this_selected_terms <- this_terms[c(9, 11, 53, 2, 61, 335), ]
...
enriched_combined <- enrichr(this_up, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(2, 3, 4, 8, 18), ]
...
enriched_combined <- enrichr(this_down, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(1, 2, 7, 64, 82), ]
...
enriched_combined <- enrichr(this_up, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(1, 2, 3, 5, 10), ]
...
enriched_combined <- enrichr(this_down, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(34, 18, 3, 5), ]
...
enriched_combined <- enrichr(this_up, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(12, 25, 31, 19, 37), ]
...
enriched_combined <- enrichr(this_down, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(1, 21, 56, 58, 72), ]
...
enriched_combined <- enrichr(this_up, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(1, 6, 2, 24, 9, 8, 49, 163), ]
...
enriched_combined <- enrichr(this_down, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(1, 3, 187, 14), ]
...
enriched_combined <- enrichr(this_up, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(1, 7, 8, 15, 26, 33 ), ]
...
enriched_combined <- enrichr(this_down, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(2, 9, 10, 24, 42, 36), ]
...
enriched_combined <- enrichr(this_up, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(1, 14, 13, 19, 17, 60), ]
...
enriched_combined <- enrichr(this_up, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(1, 3, 186, 137, 57, 102, 838), ]
...
enriched_combined <- enrichr(this_down, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(1, 14, 20, 41, 34), ]
...
enriched_combined <- enrichr(this_up, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(1, 9, 12, 27, 454), ]
...
enriched_combined <- enrichr(this_down, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(2, 1, 17, 25, 31), ]
...
enriched_combined <- enrichr(this_up, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(8, 14, 6, 20, 21), ]
...
enriched_combined <- enrichr(this_down, dbs)
this_terms <- enriched_combined$GO_Biological_Process_2018
this_selected_terms <- this_terms[c(1, 3, 11, 26, 96, 58), ]
